		...
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<s:iterator value="recordList">
				<tr class="recordList">
					...
					<td>
						<a href="notice_editUI.action?id=${id }&pageNum=${currentPage}">编辑</a>
						<a href="notice_delete.action?id=${id}&pageNum=${currentPage}" onclick="return confirm('确定要删除这个公告么？')">删除</a>
					</td>
				</tr>
			</s:iterator>
		</table>
		...
		<div id="Page">
				...
				<script type="text/javascript">
					function gotoPage(pageNum){
						...
						window.location.href="notice_list.action?pageNum="+pageNum;
					}
				</script>
				<script type="text/javascript">
