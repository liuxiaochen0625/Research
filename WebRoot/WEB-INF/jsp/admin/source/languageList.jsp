	...
	<script type="text/javascript">
		$(function(){
			$(".addNew").click(function(){
				window.location.href="language_addUI.action";
			})
		})
	</script>
</head>
<body>
	...
	<!-- 资源部分开始 -->
	<div class="language_list" style="padding-left:50px;padding-right:50px;padding-top:2px;">
		
		<table cellspacing="0" cellpadding="0" border="0" class="source_list_table" style="padding-left:40px;">
				<tr class="tableTitle">
					<td style="width:40px;">Id</td>
					<td style="width:600px;">语言</td>
				...
				<s:iterator value="recordList">
					<tr class="recordList">
						...
						<td>${language }</td>
						<td>
							<a href="${pageContext.request.contextPath}/admin/language_editUI.action?id=${id}&pageNum=${currentPage}">编辑</a>
							<a href="${pageContext.request.contextPath}/admin/language_delete.action?id=${id}&pageNum=${currentPage}" onclick="return confirm('确定要删除吗？')">删除</a>
						</td>
					</tr>
				</s:iterator>
		</table>
		...
		<div style="padding-left:40px;padding-top:10px;">
			<img class="addNew" src="${pageContext.request.contextPath}/images/admin/right/addNew.PNG" style="cursor: pointer;"/>
		</div>
		...
		<div id="Page">
				...
				<script type="text/javascript">
					function gotoPage(pageNum){
						...
						window.location.href="language_list.action?pageNum="+pageNum;
					}
				</script>
				<script type="text/javascript">
