...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/admin/labelSave.js"></script>
	<title>类型编辑页面</title>
</head>
<body>
	<!-- 标题部分 -->
	...
	<div class="wrapper" style="padding-left:150px;padding-top:10px;">	
		<s:form action="label_%{id==null?'add.action':'edit.action'}" id="label_form">	
			<s:hidden name="id" id="id"></s:hidden>	
			<div class="source_label_saveUI" style="background:#fff;width:600px;padding:10px;">
				<label for="">输入类型：</label>
				<s:textfield name="type" cssClass="type"></s:textfield>
			</div>
