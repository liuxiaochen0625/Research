				...
				<s:iterator value="recordList">
					<tr class="recordList">
						...
						<td>
							...
							<a href="${pageContext.request.contextPath}/admin/source_editUI.action?id=${id}&pageNum=${currentPage}&flag=unchecked">编辑</a>
							<a href="${pageContext.request.contextPath}/admin/source_adminDownload.action?id=${id }">下载</a>
							<a href="${pageContext.request.contextPath}/admin/source_check.action?id=${id}&pageNum=${currentPage}" onclick="return confirm('确定要将这个资源审核通过？')">通过审核</a>
							<a href="${pageContext.request.contextPath}/admin/source_adminDelete.action?id=${id}&pageNum=${currentPage}&flag=unchecked" onclick="return confirm('确定要删除这个资源么？')">删除</a>
						</td>
					</tr>
				</s:iterator>
			</table>
			...
			<div id="Page">
				...
				<script type="text/javascript">
					function gotoPage(pageNum){
						...
						window.location.href="source_listUnchecked.action?pageNum="+pageNum;
					}
				</script>
				<script type="text/javascript">
