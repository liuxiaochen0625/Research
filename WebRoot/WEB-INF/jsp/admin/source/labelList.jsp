	...
	<script type="text/javascript">
		$(function(){
			$(".addNew").click(function(){
				window.location.href="label_addUI.action";
			})
		})
	</script>
</head>
		...
		<table cellspacing="0" cellpadding="0" border="0" class="source_list_table" style="padding-left:40px;">
				...
				<s:iterator value="recordList">
					<tr class="recordList">
						...
						<td>${type }</td>
						<td>
							<a href="${pageContext.request.contextPath}/admin/label_editUI.action?id=${id}&pageNum=${currentPage}">编辑</a>
							<a href="${pageContext.request.contextPath}/admin/label_delete.action?id=${id}&pageNum=${currentPage}" onclick="return confirm('确定要删除吗？')">删除</a>
						</td>
					</tr>
				</s:iterator>
		</table>
		...
		<div id="Page">
				...
				<script type="text/javascript">
					function gotoPage(pageNum){
						...
						window.location.href="label_list.action?pageNum="+pageNum;
					}
				</script>
				<script type="text/javascript">
